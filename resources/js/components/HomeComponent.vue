    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-6 d-flex justify-content-end align-items-center">
                <button class="btn btn-success" v-on:click="redirect_path('/create')">Création</button>
            </div>
            <div class="col-12 mt-3">
                <table class="table">
                    ...
                    <tr v-for="item in list" :key="item.id">
                        ...
                        <td>
                            <button class="btn btn-dark" v-on:click="redirect_path('/details/' + item.id)">Détail</button>
